...
const bedBox={border: "1px solid", borderColor: "gray", boxShadow: "4px 4px 6px 0px gray", width: 200, height: 260,
margin: 22, textAlign: "center"}
  return (
   <div style={bedBox}>
       ...
       {<BedModal showModal={showModal} setShowModal={setShowModal} />}
    </div>
  )
}
